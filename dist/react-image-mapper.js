	...
	_createClass(ImageMapper, [{
		...
		value: function renderAreas() {
			...
			return this.state.map.areas.map(function (area, index) {
				...
				return _react2['default'].createElement('area', { key: area._id || index, shape: area.shape, coords: scaledCoords.join(','), alt: area.alt || "",
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement('img', { style: this.styles.img, src: this.props.src, useMap: '#' + this.state.map.name, alt: this.props.alt || "",
					ref: function (node) {
